                        ...
                        ?>
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    ...
                                    <a class="btn btn-xs btn-danger" href="#modalHapusPelanggan<?php echo $id ?>" data-toggle="modal" title="Nonaktifkan"><span class="fa fa-close"></span> Nonaktifkan</a>
                                    <a class="btn btn-xs btn-success" href="#modalHapusPelanggan1<?php echo $id ?>" data-toggle="modal" title="Aktifkan"><span class="fa fa-true"></span> Aktifkan</a>
                ...
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/pengguna/tambah_pengguna' ?>">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-3">Username / Email</label>
                                <div class="col-xs-9">
