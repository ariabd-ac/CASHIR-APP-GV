...
class M_laporan extends CI_Model{
	...
	function get_data_pembelian(){
		$hsl=$this->db->query("SELECT beli_kode,DATE_FORMAT(beli_tanggal,'%d %M %Y') AS beli_nofak,beli_tanggal,d_beli_id,d_beli_nofak,d_beli_barang_id,d_beli_harga,d_beli_jumlah,d_beli_total FROM tbl_beli JOIN tbl_detail_beli ON beli_kode=d_beli_kode WHERE beli_tanggal ORDER BY beli_kode DESC");

		return $hsl;
	}
	function get_total_pembelian(){
		$hsl=$this->db->query("SELECT beli_kode,DATE_FORMAT(beli_tanggal,'%d %M %Y') AS beli_nofak,beli_tanggal,d_beli_id,d_beli_nofak,d_beli_barang_id,d_beli_harga,d_beli_jumlah,SUM(d_beli_total) as total FROM tbl_beli JOIN tbl_detail_beli ON beli_kode=d_beli_kode WHERE beli_tanggal ORDER BY beli_kode DESC");
		return $hsl;
	}
	...
	function get_data_beli_pertanggal($tanggal){
		$hsl=$this->db->query("SELECT beli_kode,DATE_FORMAT(beli_tanggal,'%d %M %Y') AS beli_nofak,beli_tanggal,d_beli_id,d_beli_nofak,d_beli_barang_id,d_beli_harga,d_beli_jumlah,d_beli_total FROM tbl_beli JOIN tbl_detail_beli ON beli_kode=d_beli_kode WHERE DATE(beli_tanggal)='$tanggal' ORDER BY beli_kode DESC");
		return $hsl;
	}
